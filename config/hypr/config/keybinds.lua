...
hl.bind(mainMod .." + G", hl.dsp.exec_cmd("serpantinum msg toggle system"))
hl.bind(mainMod .." + CTRL", hl.dsp.exec_cmd("serpantinum msg toggle wallpaper"))
...
for i = 1, 10 do
	local ws = tostring(i)
	local keycode = 9 + i
	hl.bind(mainMod .." + code:".. tostring(keycode), hl.dsp.exec_cmd("serpantinum msg workspace " .. ws))
	hl.bind(mainMod .." + SHIFT + code:" .. tostring(keycode), hl.dsp.exec_cmd("serpantinum msg workspace " .. ws .. " move"))
end
